...
Adopting Web APIs and leveraging [💥 srvx](https://srvx.h3.dev) simplified H3’s scope significantly without worry about runtime differences.

- ✅ A Web-standard server optimized for performance.
- ✅ Simple and typed responses and error handling (return or throw directly).
- ✅ Fast routing via the tiny router ([🌳 rou3](https://github.com/h3js/rou3)).
- ✅ Middleware for request, response, and error interception.
- ✅ Tiny core and lots of composable, treeshakable utilities.
...
This method, allowed H3 v2 to have optimized latency improvements per request and dramatically smaller core bundle size. We also made a brand-new tiny router ([🌳 rou3](https://github.com/h3js/rou3)) based on this new metrics.
...
We've tried to minimize breaking changes. Almost all composable utilities have been ported for backward compatibility, and the main changes are in the `app` API.
